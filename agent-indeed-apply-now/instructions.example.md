# Indeed Apply Now — Agent Instructions
...
- Reminders / interstitials / confirmation pop-ups (e.g. "Continue applying"): always
  proceed — click the button that continues; never "Cancel" or anything that backs out.
...
- Full name: <your name>
- Email: <your email>
- Phone / mobile number: <your number>
